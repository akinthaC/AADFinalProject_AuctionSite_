...
$('#submitListingLands').on('click', function(e) {
    ...
    formData.append("landName", $("#landName").val());
    formData.append("location", $("#location").val());
    formData.append("currentUse", $("#currentUse").val());
    formData.append("size", $("#size").val());
    formData.append("topography", $("#topography").val());
    formData.append("waterAvailability", $("#waterAvailability").val());
    formData.append("access", $("#access").val());
    formData.append("soilQuality", $("#soilQuality").val()); // Fixed: Should be text, not file
    ...
    formData.append("startPrice", $("#startPrice").val() || 0);
    formData.append("reservePrice", $("#reservePrice").val() || 0);
    formData.append("auctionDuration", $("#auctionDuration").val());
    formData.append("paymentTerms", $("#paymentTerms").val());
    formData.append("auctionStartDate", $("#auctionStartDate").val());
    ...
    $.ajax({
        url: 'http://localhost:8080/api/listings/Land',
        method: 'POST',
        processData: false,
        contentType: false,
        data: formData,
